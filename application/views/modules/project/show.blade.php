                ...
                <form id="card-item-modal-form">
                    <div class="card-item-modal-content">
                        <div class="form-group">
                            <label for="i-description" class="font-weight-bold">Description</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="i-status" class="font-weight-bold">Status</label>
...
@section('footer')
<script src="{{ base_url('assets/main/js/invoice.js') }}"></script>
